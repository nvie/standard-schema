...
| [call-api](https://github.com/zayne-labs/callapi)                             | A lightweight fetching library with retries, interceptors, request deduplication and more                                             | [PR](https://github.com/zayne-labs/call-api/pull/131)                                                 |
...
| [Better-fetch](https://github.com/bekacru/better-fetch)                       | Advanced fetch library for TypeScript with Zod validation, pre-defined routes, hooks, plugins and more                                | [Docs](https://better-fetch.vercel.app/)                                                              |
...
| [Event Tracker](https://event-tracker.offlegacy.org/en)                       | A library for event tracking in React applications                                                                                    | [Docs](https://event-tracker.offlegacy.org/en/docs/data-type-validation)                              |
